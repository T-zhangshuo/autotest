...
public class AutoIdUtils {
    ...
    public AutoIdUtils(long datacenterId) {
    ...
    private static AutoIdUtils instance;

    public static AutoIdUtils get() {
        if (instance == null) {
            //系统的 datacenterId
            instance = new AutoIdUtils();
            int datacenterId = 0;
            instance = new AutoIdUtils(datacenterId);
        }
        return instance;
    }
}